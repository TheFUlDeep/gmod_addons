...
--TODO функция занятости. После спавна всех светофоров для каждого ссветофора создается список ноудов, которым принадлежит блок участок этого светофора (до следующих светофоров (берется из списка некст сигналов, либо некст сигнал линк), либо до конца трека). И как только состав на нужном треке и на нужном ноуде, то занятость активируется
