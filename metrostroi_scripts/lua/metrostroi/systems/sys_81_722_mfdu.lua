        ...
        if self.MFDUL2State == 2 then --Номер маршрута и т.д
            ...
            if 561 < x and x < 561+78 and 537 < y and y < 537+62 then
                if value then
                    ...
                    if self.Selected == 1 then self.RouteNumber = self.RouteN end
                    if self.Selected == 2 then self.StationNumber = self.StationN end
                    if self.Selected == 3 then self.DriverNumber = self.DriverN end
